...
a persistence unit "examenlojaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenloja/pom.xml":
...
artifact ("examenloja.war") is already built. You can build
